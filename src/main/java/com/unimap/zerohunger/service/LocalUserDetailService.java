...
import com.unimap.zerohunger.exception.ResourceNotFoundException;
...
public class LocalUserDetailService implements UserDetailsService {
    ...
    public LocalUser loadUserById(Long id) {
        final User user = userService.findUserById(id).orElseThrow(() -> new ResourceNotFoundException("User", "id", id));
        return createLocalUser(user);
    }
